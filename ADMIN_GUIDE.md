...
# 3. Export to Parquet (from SQLite database)
npm run index:export

# 4. Bundle viewer (only needed once)
npm run web:bundle

# 5. Deploy everything to Arweave
npm run deploy:complete
```

**Important Notes:**
- arxiv.db is your source of truth - never delete it!
- PDFs in downloads/ folder need matching database records
- Parquet files are read-only exports, regenerated after uploads
